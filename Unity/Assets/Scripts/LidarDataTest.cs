...
namespace Assets.Scripts
{
    ...
    {
        public static LidarWorldData[] Load16CubeDataSet(string filepath, int cubeCount)
        {
            ...
            for (int cubeIndex = 0; cubeIndex < cubeCount; cubeIndex++)
            {
                ...
                result[cubeIndex] = new LidarWorldData(dataPoints, LidarConstants.ChunkSize, LidarConstants.ChunkSize, LidarConstants.ChunkSize);
            }
